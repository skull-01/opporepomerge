...
def test_package_release_script_creates_runtime_zip_dev_source_and_checksum(tmp_path):
    ...
    runtime_zip = out / "script.oppo203.iso.external-2.9.10-build6-test.zip"
    dev_zip = out / "script.oppo203.iso.external-2.9.10-build6-test-dev-source.zip"
    checksum = out / "script.oppo203.iso.external-2.9.10-build6-test.sha256"
