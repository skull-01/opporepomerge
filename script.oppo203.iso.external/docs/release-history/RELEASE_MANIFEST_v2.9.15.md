# Release Manifest — v2.9.15 Final

Final artifacts:

- `script.oppo203.iso.external-2.9.15.zip`
- `script.oppo203.iso.external-2.9.15-dev-source.zip`
- `script.oppo203.iso.external-2.9.15-artifacts-bundle.zip`
- `script.oppo203.iso.external-2.9.15.sha256`
