...
The Sony helper is ready for user-owned fake/live-lab evaluation only after explicit experimental acknowledgement. Secrets must remain redacted in any exported diagnostics.
