# Coverage Report — v2.2.0 Build 2
...
resources/lib/first_run_wizard.py             92      0     28      1    99%   124->131
...
--------------------------------------------------------------------------------------
TOTAL                                       2611      7    924     13    99%

```

Raw combined line+branch coverage: 99.43422913719944%.
Displayed coverage: 99%.
