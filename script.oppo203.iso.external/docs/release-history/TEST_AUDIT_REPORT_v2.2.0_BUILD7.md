# Test and Audit Report — v2.2.0 Build 7

## Source verification

```text
python -m pytest -q
512 passed, 12 subtests passed
...
SUMMARY: PASS (89/89 checks passed)
```
...
OK: file:BUILD_NOTES_v2.2.0_BUILD7.md - present
OK: file:RELEASE_MANIFEST_v2.2.0_BUILD7.md - present
OK: file:COVERAGE_REPORT_v2.2.0_BUILD7.md - present
OK: file:TEST_AUDIT_REPORT_v2.2.0_BUILD7.md - present
OK: addon_xml_declaration - version=1.0
OK: addon_version - 2.2.0.7
SUMMARY: PASS (89/89 checks passed)
