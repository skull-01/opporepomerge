...
- **Branch:** `claude/svm3-monitor-0a03dc35` (stacked on PR A1). ENH (to be filed by operator: "SVM3 OPPO playback monitor", `area:addon`); relates to the verify-played follow-through (#113).
...
- **Branch:** `claude/svm3-session-engine-88d77e42` (stacked on PR A2). ENH (to be filed by operator: "Shared playback-session engine (four-option) + status JSON", `area:addon`).
