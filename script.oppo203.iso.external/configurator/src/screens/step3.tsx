    ...
    <div className="screen">
      ...
      <div className="stack" style={{ gap: 14 }}>
        <div className="row" style={{ gap: 10 }}>
          ...
          <button className="btn ghost sm" onClick={() => go("step3_notfound")}>
      ...
      <FooterNav
        go={go}
        back="step3_brand"
        next={state.tvModel ? "step3_adb_warn" : null}
        nextLabel="Continue"
      />
    </div>
  );
...
// ============================================================
export function Step3NotFound({ go, set }: ScreenProps) {
  return (
    <div className="screen">
      <div className="screen-header">
      ...
      <div className="grid-2">
        <button className="tile" onClick={() => go("step3_probe")}>
      ...
      <FooterNav go={go} back="step3_model" />
    </div>
  );
}
...
// STEP 3 — Probe
// ============================================================
export function Step3Probe({ go, set }: ScreenProps) {
    ...
    <div className="screen">
      ...
      <div className="split" style={{ marginTop: 8 }}>
        ...
        <div className="stack">
          ...
          <button className="btn primary lg" onClick={() => go("step3_test")}>
...
export function Step3Test({ go, state, set }: ScreenProps) {
  ...
  return (
    <div className="screen">
      ...
      <FooterNav go={go} back="step3_adb_warn" />
    </div>
  );
}
...
// STEP 3 — Test failed
// ============================================================
export function Step3Fail({ go, set }: ScreenProps) {
  return (
    <div className="screen">
      <div className="screen-header">
      ...
      <FooterNav go={go} back="step3_test" />
    </div>
  );
}
